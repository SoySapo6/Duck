...
let drm1 = ""
let drm2 = ""
let rtx = "「❑」 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐜𝐢𝐨́𝐧 𝐩𝐨𝐫 𝐐𝐑\n\n✰ Escanea este 𝐂𝐨́𝐝𝐢𝐠𝐨 𝐐𝐑 con otro celular o desde la PC para activar un 𝐒𝐮𝐛-𝐁𝐨𝐭 𝐭𝐞𝐦𝐩𝐨𝐫𝐚𝐥.\n\n「❑」 `1` » Abre el menú (tres puntos en la esquina superior derecha)\n「❑」 `2` » Selecciona 𝐃𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯𝐨𝐬 𝐯𝐢𝐧𝐜𝐮𝐥𝐚𝐝𝐨𝐬\n「❑」 `3` » Escanea el 𝐂𝐨́𝐝𝐢𝐠𝐨 𝐐𝐑 mostrado aquí\n\n✧ 𝐀𝐝𝐯𝐞𝐫𝐭𝐞𝐧𝐜𝐢𝐚: Este código expira en 𝐚𝐩𝐫𝐨𝐱. 45 𝐬𝐞𝐠𝐮𝐧𝐝𝐨𝐬."
let rtx2 = "「❑」 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐜𝐢𝐨́𝐧 𝐩𝐨𝐫 𝐂𝐨́𝐝𝐢𝐠𝐨\n\n✰ Usa este 𝐂𝐨́𝐝𝐢𝐠𝐨 𝐍𝐮𝐦𝐞́𝐫𝐢𝐜𝐨 para activar un 𝐒𝐮𝐛-𝐁𝐨𝐭 𝐭𝐞𝐦𝐩𝐨𝐫𝐚𝐥.\n\n「❑」 `1` » Abre el menú (tres puntos en la esquina superior derecha)\n「❑」 `2` » Entra en 𝐃𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯𝐨𝐬 𝐯𝐢𝐧𝐜𝐮𝐥𝐚𝐝𝐨𝐬\n「❑」 `3` » Selecciona 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐫 𝐜𝐨𝐧 𝐧𝐮́𝐦𝐞𝐫𝐨 𝐝𝐞 𝐭𝐞𝐥𝐞́𝐟𝐨𝐧𝐨\n「❑」 `4` » Ingresa el 𝐂𝐨́𝐝𝐢𝐠𝐨 mostrado aquí\n\n✧ 𝐑𝐞𝐜𝐨𝐦𝐞𝐧𝐝𝐚𝐜𝐢𝐨́𝐧: No utilices tu 𝐜𝐮𝐞𝐧𝐭𝐚 𝐩𝐫𝐢𝐧𝐜𝐢𝐩𝐚𝐥."
